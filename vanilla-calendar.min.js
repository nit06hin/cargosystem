...
! function(e, t) {
	...
	return function() {
		function n(t, a) {
			var l, s, i, c, r, d, o, u, v, h, g, m, y, p, b, T, M, f, _, D, w, L, k, H, Y, C, U, x, E, N, A, S, K, F, q, O, P, j, W, I, V, $, z, B, G, J, Q, R, X, Z, ee, te, ae, ne, le, se, ie, ce, re, de, oe, ue, ve, he, ge, me, ye, pe, be, Te, Me, fe, _e, De, we, Le, ke, He, Ye, Ce, Ue, xe, Ee, Ne, Ae, Se, Ke, Fe, qe, Oe;
			! function(e, t) {
				if(!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
			}(this, n), this.HTMLElement = "object" === e(t) ? t : document.querySelector(t), this.HTMLElement && (this.type = null !== (l = null == a ? void 0 : a.type) && void 0 !== l ? l : "default", this.date = {
			...
			}, this.popups = null !== (Oe = null == a ? void 0 : a.popups) && void 0 !== Oe ? Oe : null, this.currentType = this.type, this.selectedKeeping = null, this.userTime = !1)
		}
		var l, s, i;
		return l = n, (s = [{
			key: "generateDate",
			...
			value: function(e) {
				var t = Number(e),
					a = t;
				return 0 === t ? a = "12" : 13 === t ? a = "01" : 14 === t ? a = "02" : 15 === t ? a = "03" : 16 === t ? a = "04" : 17 === t ? a = "05" : 18 === t ? a = "06" : 19 === t ? a = "07" : 20 === t ? a = "08" : 21 === t ? a = "09" : 22 === t ? a = "10" : 23 === t && (a = "11"), a
			}
		}, {
			key: "transformTime24",
			value: function(e, t) {
				var a = Number(e),
					n = a;
				return "AM" === t ? 12 === a && (n = "00") : "PM" === t && (1 === a ? n = "13" : 2 === a ? n = "14" : 3 === a ? n = "15" : 4 === a ? n = "16" : 5 === a ? n = "17" : 6 === a ? n = "18" : 7 === a ? n = "19" : 8 === a ? n = "20" : 9 === a ? n = "21" : 10 === a ? n = "22" : 11 === a && (n = "23")), n
			}
		}, {
			...
			value: function() {
				...
				if(["default", "year"].includes(this.currentType)) {
					...
					}(), "year" === e.currentType && (e.dateMin.getUTCFullYear() && e.viewYear - 7 <= e.dateMin.getUTCFullYear() ? t.style.visibility = "hidden" : t.style.visibility = null, e.dateMax.getUTCFullYear() && e.viewYear + 7 >= e.dateMax.getUTCFullYear() ? a.style.visibility = "hidden" : a.style.visibility = null)
				}
			}
		}, {
			key: "createWeek",
			value: function() {
				...
				for(var l = 0; l < n.length; l++) {
					var s = n[l],
						i = t.cloneNode(!0);
					this.settings.visibility.weekend && this.settings.iso8601 ? 5 !== l && 6 !== l || i.classList.add("vanilla-calendar-week__day_weekend") : this.settings.visibility.weekend && !this.settings.iso8601 && (0 !== l && 6 !== l || i.classList.add("vanilla-calendar-week__day_weekend")), i.innerText = "".concat(s), e.append(i)
				}
			}
		}, {
			key: "getWeekNumber",
			...
			value: function() {
				...
				s.className = "vanilla-calendar-day", i.className = "vanilla-calendar-day__btn", i.type = "button", ["single", "multiple", "multiple-ranged"].includes(this.settings.selection.day) && l.classList.add("vanilla-calendar-days_selecting"), l.innerHTML = "";
				var c = function(t, a, n, c, r) {
					var d = s.cloneNode(!0),
						o = i.cloneNode(!0);
					r && o.classList.add(r), o.innerText = t, o.dataset.calendarDay = n,
						function(t, a, n, l) {
							!e.settings.visibility.weekend || 0 !== a && 6 !== a || t.classList.add("vanilla-calendar-day__btn_weekend"), Array.isArray(e.settings.selected.holidays) && e.settings.selected.holidays.forEach((function(e) {
				...
				}(), this.createPopup(l), this.createWeekNumbers(n, a)
			}
		}, {
			key: "changeMonth",
			value: function(e) {
			...
			value: function() {
				...
				for(var a = this.viewYear - 7; a < this.viewYear + 8; a++) {
					var n = a,
						l = t.cloneNode(!0);
					n === this.selectedYear && l.classList.add("vanilla-calendar-years__year_selected"), n < this.dateMin.getUTCFullYear() && l.classList.add("vanilla-calendar-years__year_disabled"), n > this.dateMax.getUTCFullYear() && l.classList.add("vanilla-calendar-years__year_disabled"), l.dataset.calendarYear = n, l.innerText = "".concat(n), e.append(l)
				}
			}
		}, {
			key: "createMonths",
			value: function() {
				...
				for(var a = 0; a < this.locale.months.length; a++) {
					var n = this.locale.months[a],
						l = t.cloneNode(!0);
					a === this.selectedMonth && l.classList.add("vanilla-calendar-months__month_selected"), a < this.dateMin.getUTCMonth() && this.selectedYear === this.dateMin.getUTCFullYear() && l.classList.add("vanilla-calendar-months__month_disabled"), a > this.dateMax.getUTCMonth() && this.selectedYear === this.dateMax.getUTCFullYear() && l.classList.add("vanilla-calendar-months__month_disabled"), l.dataset.calendarMonth = a, l.title = "".concat(n), l.innerText = "".concat(this.settings.visibility.monthShort ? n.substring(0, 3) : n), e.append(l)
				}
			}
		}, {
			key: "controlTime",
			value: function(e) {
				var t = this,
					...
					d = function(e, a, n) {
						"hours" === n ? t.selectedHours = "".concat(a) : "minutes" === n && (t.selectedMinutes = "".concat(a)), t.selectedTime = "".concat(t.selectedHours, ":").concat(t.selectedMinutes).concat(t.selectedKeeping ? " ".concat(t.selectedKeeping) : ""), t.settings.selected.time = t.selectedTime, t.actions.changeTime && t.actions.changeTime(e, t.selectedTime, t.selectedHours, t.selectedMinutes, t.selectedKeeping)
					},
					o = function(e, a, n, l) {
						e.addEventListener("input", (function(e) {
							var s = Number(e.target.value);
							s = s < 10 ? "0".concat(s) : "".concat(s), "hours" === n && 12 === l ? Number(e.target.value) < l && Number(e.target.value) > 0 ? (a.value = s, t.selectedKeeping = "AM", i.innerText = t.selectedKeeping, d(e, s, n)) : (0 === Number(e.target.value) ? (t.selectedKeeping = "AM", i.innerText = "AM") : (t.selectedKeeping = "PM", i.innerText = "PM"), a.value = t.transformTime12(e.target.value), d(e, t.transformTime12(e.target.value), n)) : (a.value = s, d(e, s, n))
						}))
					},
					u = function(e, a, n, l) {
						a.addEventListener("change", (function(a) {
							var s = Number(a.target.value);
							s = s < 10 ? "0".concat(s) : "".concat(s), "hours" === n && 12 === l ? a.target.value && Number(a.target.value) <= l && Number(a.target.value) > 0 ? (a.target.value = s, e.value = t.transformTime24(s, t.selectedKeeping), d(a, s, n)) : a.target.value && Number(a.target.value) < 24 && (Number(a.target.value) > l || 0 === Number(a.target.value)) ? (0 === Number(a.target.value) ? (t.selectedKeeping = "AM", i.innerText = "AM") : (t.selectedKeeping = "PM", i.innerText = "PM"), a.target.value = t.transformTime12(a.target.value), e.value = s, d(a, t.transformTime12(a.target.value), n)) : a.target.value = t.selectedHours : a.target.value && Number(a.target.value) <= l && Number(a.target.value) >= 0 ? (a.target.value = s, e.value = s, d(a, s, n)) : "hours" === n ? a.target.value = t.selectedHours : "minutes" === n && (a.target.value = t.selectedMinutes)
						}))
					};
				c(a, l), c(n, s), r(a, l), r(n, s), o(a, l, "hours", 24 === e ? 23 : e), o(n, s, "minutes"), u(a, l, "hours", 24 === e ? 23 : e), u(n, s, "minutes", 59), i && i.addEventListener("click", (function(e) {
					i.innerText.includes("AM") ? t.selectedKeeping = "PM" : t.selectedKeeping = "AM", a.value = t.transformTime24(t.selectedHours, t.selectedKeeping), d(e, t.selectedHours, "hours"), i.innerText = t.selectedKeeping
				}))
			}
		}, {
			key: "createTime",
			...
			value: function() {
				if("define" !== this.settings.lang) {
					this.locale.weekday = [];
					for(var e = 0; e < 7; e++) {
						var t = new Date(0, 0, e).toLocaleString(this.settings.lang, {
							weekday: "short"
						});
					...
					this.locale.months = [];
					for(var a = 0; a < 12; a++) {
						var n = new Date(0, a).toLocaleString(this.settings.lang, {
							month: "long"
						});
			...
			key: "update",
			value: function() {
				this.setVariablesDates(), this.getLocale(), this.createDOM(), this.createHeader(), this.controlArrows(), this.createTime(), "default" === this.currentType ? (this.createWeek(), this.createDays()) : "month" === this.currentType ? this.createMonths() : "year" === this.currentType && this.createYears()
			}
		}, {
			key: "click",
			value: function() {
						...
						function() {
							if(["single", "multiple", "multiple-ranged"].includes(e.settings.selection.day) && s) {
								switch(e.settings.selection.day) {
									case "single":
                                        console.log(s.dataset.calendarDay);
										s.classList.contains("vanilla-calendar-day__btn_selected") ? e.selectedDates.splice(e.selectedDates.indexOf(s.dataset.calendarDay), 1) : (e.selectedDates = [], e.selectedDates.push(s.dataset.calendarDay));
										break;
									case "multiple":
										s.classList.contains("vanilla-calendar-day__btn_selected") ? e.selectedDates.splice(e.selectedDates.indexOf(s.dataset.calendarDay), 1) : e.selectedDates.push(s.dataset.calendarDay);
										break;
									case "multiple-ranged":
										! function() {
											if(e.selectedDates.length > 1 && (e.selectedDates = []), e.selectedDates.push(s.dataset.calendarDay), e.selectedDates[1]) {
												var t = new Date(Date.UTC(new Date(e.selectedDates[0]).getUTCFullYear(), new Date(e.selectedDates[0]).getUTCMonth(), new Date(e.selectedDates[0]).getUTCDate())),
													a = new Date(Date.UTC(new Date(e.selectedDates[1]).getUTCFullYear(), new Date(e.selectedDates[1]).getUTCMonth(), new Date(e.selectedDates[1]).getUTCDate())),
													n = function(t) {
														var a = e.generateDate(t);
                                                        console.log(a);
														e.settings.range.disabled && e.settings.range.disabled.includes(a) || e.selectedDates.push(a)
													};
												if(e.selectedDates = [], a > t)
													for(var l = t; l <= a; l.setUTCDate(l.getUTCDate() + 1)) n(l);
												else
													for(var i = t; i >= a; i.setUTCDate(i.getUTCDate() - 1)) n(i)
											}
										}()
								}
								e.actions.clickDay && e.actions.clickDay(t, e.selectedDates), e.settings.selected.dates = e.selectedDates, i ? e.changeMonth("prev") : c ? e.changeMonth("next") : e.createDays()
							}
						}(), e.settings.selection.year && (a && "year" === e.currentType ? (l ? e.viewYear += 15 : n && (e.viewYear -= 15), e.createYears()) : "year" !== e.currentType && r ? e.createYears() : "year" === e.currentType && r ? (e.currentType = e.type, e.update()) : d && (e.selectedYear = Number(d.dataset.calendarYear), e.currentType = e.type, e.selectedMonth < e.dateMin.getUTCMonth() && e.selectedYear === e.dateMin.getUTCFullYear() && (e.settings.selected.month = e.dateMin.getUTCMonth()), e.selectedMonth > e.dateMax.getUTCMonth() && e.selectedYear === e.dateMax.getUTCFullYear() && (e.settings.selected.month = e.dateMax.getUTCMonth()), e.actions.clickYear && e.actions.clickYear(t, e.selectedYear), e.settings.selected.year = e.selectedYear, e.update())), e.settings.selection.month && ("month" !== e.currentType && o ? e.createMonths() : "month" === e.currentType && o ? (e.currentType = e.type, e.update()) : u && (e.selectedMonth = Number(u.dataset.calendarMonth), e.currentType = e.type, e.actions.clickMonth && e.actions.clickMonth(t, e.selectedMonth), e.settings.selected.month = e.selectedMonth, e.update()))
				}))
			}
		}, {
			key: "init",
		...
		}]) && t(l.prototype, s), i && t(l, i), Object.defineProperty(l, "prototype", {
			writable: !1
		}), n
	}()
}));
